...
function searchTechnique() {
    ...
    var mitreData = {
        ...
        "TA0010": ["exfiltration/net_connection_win_mega_nz.yml","exfiltration/aws_snapshot_backup_exfiltration.yml","exfiltration/net_connection_win_ngrok_io.yml","proc_creation_win_pua_rclone_execution.yml"],
